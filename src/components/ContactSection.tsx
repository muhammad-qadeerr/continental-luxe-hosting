...
// Initialize EmailJS with public key from env (required by EmailJS)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (!serviceId || !templateId) {
        throw new Error(
          "EmailJS configuration missing. Set VITE_EMAILJS_SERVICE_ID and VITE_EMAILJS_TEMPLATE_ID in your env."
        );
      }
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <form
            ...
            className="glass border-gold-glow p-10 space-y-6"
          >
            ...
            <div className="space-y-2">
              ...
              <Textarea
                placeholder="Low bookings, visibility issues, etc."
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center gap-2">
                  <RadioGroupItem value="whatsapp" className="border-primary" />
                  <Label className="cursor-pointer">WhatsApp</Label>
                </div>
                <div className="flex items-center gap-2">
                  <RadioGroupItem value="phone" className="border-primary" />
                  <Label className="cursor-pointer">Phone</Label>
                </div>
                <div className="flex items-center gap-2">
                  <RadioGroupItem value="email" className="border-primary" />
